...
class FloatingTextParticle extends Particle{
	...
	public function encode(){
		...
		if(!$this->invisible){
			...
			$add->entries = [PlayerListEntry::createAdditionEntry($uuid, $this->entityId, $name, SkinAdapterSingleton::get()->toSkinData(new Skin("Standard_Custom", null, str_repeat("\x00", 8192))))];
			$p[] = $add;
